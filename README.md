...
The social tab is also messy and will be redesigned to utilise familiar logos that will help inform the user where the links will take them.Requirement 2 – Dataflow Diagram 
...
Customer Login (User)
Customers/Clients can register accounts to unlock more interactivity with the site. It is not compulsory. The HTTP verbs in the dataflow diagram accurately depict activities that a user can perform such as POST a review or GET pricing information related to an artist. Some of this information will be able to non-users, such as portfolios and galleries, actions that require POST are strictly limited to users and admins.
...
The picture on the next slide is a terrific example of how communication takes place between different sides of the application and studying the image will inform you of all user facing operations.Requirement 4: User Stories
...
Information surrounding application of aftercare: when, how, why?
...
User Story 5 – I am the organizer of a popular tattoo convention. I am looking to extend an invitation to select shops based on their capabilities and reputation
